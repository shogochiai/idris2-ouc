...
import { idlFactory } from './ouc.did.js';
export { idlFactory } from './ouc.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_OUC;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ouc.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ouc canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ouc.did.js")._SERVICE>}
 */
export const ouc = createActor(canisterId);
