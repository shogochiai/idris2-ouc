...
import { idlFactory } from './ic0_test.did.js';
export { idlFactory } from './ic0_test.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_IC0_TEST;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ic0_test.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ic0_test canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ic0_test.did.js")._SERVICE>}
 */
export const ic0_test = createActor(canisterId);
